...
So the mean is `r format(meanperday,digits=1)` and the median is `r medianperday`.
...
So the mean is `r format(newmeanperday,digits=1)` (a difference of `r newmeanperday - meanperday` ) and the median is `r newmedianperday` (a difference of `r newmedianperday - medianperday` ).
